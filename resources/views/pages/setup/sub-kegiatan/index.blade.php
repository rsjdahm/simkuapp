<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4>Nomenklatur Sub Kegiatan</h4>
    ...
    <div class="row">
        <div class="col-12">
            <a data-load="modal" title="Tambah Nomenklatur Sub Kegiatan" href="{{ route('sub-kegiatan.create') }}"
            ...
            <div class="card bg-light mb-3">
                <div class="card-body p-2">
                    ...
                    <div class="form-group mb-0">
                        <div class="row">
                            <div class="col-lg-2">
                                <label><i class="fas fa-filter"></i> Kegiatan:</label>
                            </div>
                            <div class="col-lg-10">
                                <select name="kegiatan_id_filter" class="form-control"
                                    data-filter-datatable="#{{ $rand }}">
                                    <option value="">Semua Kegiatan</option>
                                    @foreach ($kegiatan as $kegiatan_item)
                                        <option value="{{ $kegiatan_item->id }}"
                                            data-program_id="{{ $kegiatan_item->program_id }}" class="d-none">
...
<script>
    ...
    $("select[name='program_id_filter']").change(function(event) {
        $("select[name='kegiatan_id_filter']").val('').trigger('change');
        $("select[name='kegiatan_id_filter'] option").removeClass('d-none');
        $("select[name='kegiatan_id_filter'] option[data-program_id]:not([data-program_id='" + $(
                "select[name='program_id_filter']")
            .val() + "'])").addClass('d-none');
    });
</script>
