    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4>Rekening Sub Rincian Objek</h4>
                ...
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item active">Rekening Sub Rincian Objek</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="card bg-light mb-3">
                <div class="card-body p-2">
                    ...
                    <div class="form-group mb-0">
                        <div class="row">
                            <div class="col-lg-2">
                                <label><i class="fas fa-filter"></i> Rekening Rincian Objek:</label>
                            </div>
                            <div class="col-lg-10">
                                <select name="rek_rincian_objek_id_filter" class="form-control"
                                    data-filter-datatable="#{{ $rand }}">
                                    <option value="" selected>Semua Rekening Rincian Objek</option>
                                    @foreach ($rek_rincian_objek as $rek_rincian_objek_item)
                                        <option value="{{ $rek_rincian_objek_item->id }}"
                                            data-rek_objek_id="{{ $rek_rincian_objek_item->rek_objek_id }}"
                                            class="d-none">
...
<script>
    ...
    $("select[name='rek_objek_id_filter']").change(function(event) {
        $("select[name='rek_rincian_objek_id_filter']").val('').trigger('change');
        $("select[name='rek_rincian_objek_id_filter'] option").removeClass('d-none');
        $("select[name='rek_rincian_objek_id_filter'] option[data-rek_objek_id]:not([data-rek_objek_id='" + $(
                "select[name='rek_objek_id_filter']")
            .val() + "'])").addClass('d-none');
    });
</script>
