...
<body style="border: 1px solid black; padding: 5px 0 5px 0;">
    ...
    <div style="text-align: center;">
        Untuk Rekening Akun, Kelompok, Jenis, Objek, Rincian Objek, dan Sub
        Rincian Objek
    </div>
    <br />
    <br />
                            ...
                            @foreach ($rek_jenis_item->rek_objek->sortBy('kode_lengkap') as $rek_objek_item)
                                ...
                                @foreach ($rek_objek_item->rek_rincian_objek->sortBy('kode_lengkap') as $rek_rincian_objek_item)
                                    ...
                                    @foreach ($rek_rincian_objek_item->rek_sub_rincian_objek->sortBy('kode_lengkap') as $rek_sub_rincian_objek_item)
                                        <tr>
                                            <td>{{ $rek_sub_rincian_objek_item->kode_lengkap }}</td>
                                            <td style="padding-left: 7.5rem;">{{ $rek_sub_rincian_objek_item->nama }}
                                            </td>
                                        </tr>
                                    @endforeach
                                @endforeach
