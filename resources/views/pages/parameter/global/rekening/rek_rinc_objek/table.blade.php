    ...
    <div class="row">
        <div class="col-12">
            <table class="table-responsive table-borderless m-0 table">
                <tr>
                    ...
                    <td class="py-2">:</td>
                    <th class="py-2">{{ $rek_objek->rek_jenis->rek_kelompok->rek_akun->kd }}</th>
                ...
                <tr>
                    ...
                    <td class="py-2">:</td>
                    <th class="py-2">{{ $rek_objek->rek_jenis->rek_kelompok->kd }}</th>
                ...
                <tr>
                    ...
                    <td class="py-2">:</td>
                    <th class="py-2">{{ $rek_objek->rek_jenis->kd }}</th>
        ...
        <div class="col-12 text-right">
            <a data-load="modal" title="Tambah Rekening Akun"
                href="{{ route('rekening.rek-rinc-objek.create', ['rek_objek_id' => $rek_objek->id]) }}"
