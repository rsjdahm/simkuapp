        ...
        <div class="col-md-9">
            <table class="table-responsive m-0 table">
                <tr>
                    ...
                    <td class="py-2">:</td>
                    <th class="py-2">{{ $rek_objek->rek_jenis->rek_kelompok->rek_akun->kd_rek }}</th>
                    <td class="py-2">{{ $rek_objek->rek_jenis->rek_kelompok->rek_akun->nama }}</td>
                </tr>
                <tr>
                    ...
                    <td class="py-2">:</td>
                    <th class="py-2">{{ $rek_objek->rek_jenis->rek_kelompok->kd_rek }}</th>
                    <td class="py-2">{{ $rek_objek->rek_jenis->rek_kelompok->nama }}</td>
                </tr>
                <tr>
                    ...
                    <td class="py-2">:</td>
                    <th class="py-2">{{ $rek_objek->rek_jenis->kd_rek }}</th>
                    <td class="py-2">{{ $rek_objek->rek_jenis->nama }}</td>
                </tr>
                <tr>
                    <td class="py-2"><a data-action="back-tab" data-target="#rek_objek"
                            class="btn btn-primary btn-sm text-white"><i class="fas fa-backward"></i> Kembali</a></td>
                    <td class="py-2">Rekening Objek</td>
                    <td class="py-2">:</td>
                    <th class="py-2">{{ $rek_objek->kd_rek }}</th>
                    <td class="py-2">{{ $rek_objek->nama }}</td>
                </tr>
            </table>
        </div>
