        ...
        <div class="col-12">
            <table class="table-responsive table-borderless table-sm m-0 table">
                <tr>
                    ...
                    <td>Rekening Akun</td>
                    <td>:</td>
                    <th>{{ $rek_rinc_objek->rek_objek->rek_jenis->rek_kelompok->rek_akun->kode }}</th>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <th>{{ $rek_rinc_objek->rek_objek->rek_jenis->rek_kelompok->kode }}</th>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <th>{{ $rek_rinc_objek->rek_objek->rek_jenis->kode }}</th>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <th>{{ $rek_rinc_objek->rek_objek->kode }}</th>
