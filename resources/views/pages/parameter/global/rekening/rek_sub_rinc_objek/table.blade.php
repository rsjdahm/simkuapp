        ...
        <div class="col-md-9">
            <table class="table-responsive m-0 table">
                <tr>
                    ...
                    <td>Rekening Akun</td>
                    <td>:</td>
                    <th>{{ $rek_rinc_objek->rek_objek->rek_jenis->rek_kelompok->rek_akun->kd_rek }}</th>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <th>{{ $rek_rinc_objek->rek_objek->rek_jenis->rek_kelompok->kd_rek }}</th>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <th>{{ $rek_rinc_objek->rek_objek->rek_jenis->kd_rek }}</th>
                ...
                <tr>
                    ...
                    <td>:</td>
                    <th>{{ $rek_rinc_objek->rek_objek->kd_rek }}</th>
                    <td>{{ $rek_rinc_objek->rek_objek->nama }}</td>
                </tr>
                <tr>
                    <td><a do="back-to-tab" tab="#rek_rinc_objek" class="btn btn-primary btn-sm text-white"><i
                                class="fas fa-backward"></i> Kembali</a></td>
                    <td>Rekening Rincian Objek</td>
                    <td>:</td>
                    <th>{{ $rek_rinc_objek->kd_rek }}</th>
