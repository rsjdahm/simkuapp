    ...
    <div class="row">
        <div class="col-12">
            <table class="table-responsive table-borderless table-sm m-0 table">
                <tr>
                    <td><a data-action="back-tab" data-target="#urusan" class="btn btn-primary btn-sm text-white"><i
        ...
        <div class="col-12 text-right">
            <a data-load="modal" title="Tambah Nomenklatur Bidang"
                href="{{ route('bidang.create', ['urusan_id' => $urusan->id]) }}" class="btn btn-success text-white"><i
