...
/// urusan
Route::resource('/parameter/global/urusan-bidang/urusan', UrusanController::class, ['as' => 'urusan_bidang']);
/// bidang
Route::resource('/parameter/global/urusan-bidang/bidang', BidangController::class, ['as' => 'urusan_bidang']);
