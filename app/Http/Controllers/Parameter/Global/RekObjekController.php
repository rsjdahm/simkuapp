...
use App\Http\Requests\Parameter\Global\Rekening\RekObjekRequest;
                ...
                return DataTables::of($data)
                    ...
                    ->addColumn('action', function ($item) {
                        ...
                        <div class="btn-group btn-group-sm">
                            <a load="modal" title="Edit Rekening Objek" href="' . route('rekening.rek_objek.edit', $item->id) . '" class="btn btn-warning text-white"><i class="fas fa-edit"></i></a>
                            <a do="delete" href="' . route('rekening.rek_objek.destroy', $item->id) . '" class="btn btn-danger text-white"><i class="fas fa-trash"></i></a>
                        </div>
                        ';
                    })
                    ->addColumn('detail', function ($item) {
                        return '
                        <div class="btn-group btn-group-sm">
                            <a do="open-to-tab" target="rek_rinc_objek_page" tab="#rek_rinc_objek" href="'  . route('rekening.rek_rinc_objek.index', ['rek_objek_id' => $item->id]) .   '" class="btn btn-primary text-white"><i class="fas fa-forward"></i></a>
                        </div>
                        ';
                    })
