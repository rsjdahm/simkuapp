            ...
            if ($request->wantsJson()) {
                ...
                return DataTables::of($data)
                    ...
                    <div class="btn-group btn-group-sm">
                        <a data-load="modal" title="Edit Unit" href="' . route('unit_subunit.unit.edit', $item->id) . '" class="btn btn-warning text-white"><i class="fas fa-edit"></i></a>
                        <a data-action="delete" href="' . route('unit_subunit.unit.destroy', $item->id) . '" class="btn btn-danger text-white"><i class="fas fa-trash"></i></a>
                    </div>
                    ';
                    })
                    ->addColumn('detail', function ($item) {
                        return '
                        <div class="btn-group btn-group-sm">
                            <a data-action="open-tab" data-target="#subunit" href="' . route('unit_subunit.subunit.index', ['unit_id' => $item->id]) . '" class="btn btn-primary text-white"><i class="fas fa-forward"></i></a>
                        </div>
                        ';
                    })
