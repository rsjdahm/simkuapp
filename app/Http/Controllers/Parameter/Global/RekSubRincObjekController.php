...
use App\Http\Requests\Parameter\Global\Rekening\RekSubRincObjekRequest;
    ...
    public function index(Builder $builder, Request $request)
    {
        if ($request->rek_rinc_objek_id) {
            ...
            $table = $builder->ajax(route('rekening.rek_sub_rinc_objek.index', ['rek_rinc_objek_id' => $request->rek_rinc_objek_id]))
                ...
                ->addColumn(['data' => 'kd_rek', 'title' => 'Kode Sub Rincian Objek', 'class' => 'font-weight-bold', 'style' => 'width: 1%;'])
